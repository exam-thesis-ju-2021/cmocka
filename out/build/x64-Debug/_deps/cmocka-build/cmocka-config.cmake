...
if (EXISTS "${CMOCKA_CMAKE_DIR}/CMakeCache.txt")
    ...
    set(CMOCKA_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)
endif()

set(CMOCKA_LIBRARY ${PACKAGE_PREFIX_DIR}/lib/cmocka.lib)
set(CMOCKA_LIBRARIES ${PACKAGE_PREFIX_DIR}/lib/cmocka.lib)
